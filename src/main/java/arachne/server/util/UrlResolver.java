...
public final class UrlResolver {
     ...
     * @return the index of the first occurrence of the character in the string or
     * <tt>-1</tt>
     */
     ...
     * syntax of Section 2.2 and to describe the algorithm for resolving relative
     * URLs presented in Section 4. This section describes the parsing rules for
     * breaking down a URL (relative or absolute) into the component parts described
     * in Section 2.1. The rules assume that the URL has already been separated from
     * any surrounding text and copied to a "parse string". The rules are listed in
    ...
    /**
     * Resolves a given relative URL against a base URL using the algorithm depicted
     * in <a href="http://www.faqs.org/rfcs/rfc1808.html">RFC1808</a>:
     * <p>
     * Section 4: Resolving Relative URLs
     * <p>
     * This section describes an example algorithm for resolving URLs within a
     * context in which the URLs may be relative, such that the result is always a
     * URL in absolute form. Although this algorithm cannot guarantee that the
